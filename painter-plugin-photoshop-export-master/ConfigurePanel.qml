...
AlgDialog {
  ...
  onAccepted: {
    if (path.text != "...") {
        ...
        alg.settings.setValue("keepSmartObject", smartObjectCheckBox.checked);
  ...
  Rectangle {
    ...
    AlgScrollView {
      ...
      RowLayout {
        spacing: 6
        AlgLabel {
          text: qsTr("Enable SP built-in padding")
          Layout.fillWidth: true
        }
        ...
        AlgCheckBox {
          id: paddingCheckBox
          function reload() {
            checked = alg.settings.value("padding", true);
          }
          Component.onCompleted: { reload() }
        }
      }
      ...
      RowLayout {
        spacing: 6
        AlgLabel {
          text: qsTr("Keep layers as Smart Objects")
          Layout.fillWidth: true
        }

        AlgCheckBox {
          id: smartObjectCheckBox
          function reload() {
            checked = alg.settings.value("keepSmartObject", true);
          }
          Component.onCompleted: { reload() }
        }
      }
